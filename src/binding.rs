...
//!
//! This module defines a small schema for turning raw per-device state into a
//! normalized set of actions (scalar axes, buttons, and 2D vectors).
//!
//! # Overview
...
//!   scheme that matches your device parser(s).
//!
//! # Examples
...
impl Default for AxisCurve {
    fn default() -> Self {
        AxisCurve::Power { gamma: 1.0 } // linear when gamma=1
    }
}
